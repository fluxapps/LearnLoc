...
$app->get('/', function () use ($app) {
	response(array(
		...
		'GET /location/:id/image_data'  => 'Returns the location image',
		'GET /location/:id/thumb'       => 'Returns a thumbnail version of the location image',
		'GET /location/:id/thumb_data'  => 'Returns a thumbnail version of the location image',
		'GET /location/:id/header'      => 'Returns a header version of the location image',
		'GET /location/:id/header_data' => 'Returns a header version of the location image',
...
$app->get('/location/:id/image_data', function ($id) use ($app) {
	$service = new LocationImageService($id, array(
		'w'    => 960,
		'h'    => 960,
		'crop' => false,
...
$app->get('/location/:id/header_data', function ($id) use ($app) {
	$service = new LocationImageService($id, array(
		'w'    => 960,
		'h'    => 260,
		'crop' => false,
...
$app->get('/location/:id/thumb_data', function ($id) use ($app) {
	$service = new LocationImageService($id, array(
		'w'    => 64,
		'h'    => 64,
		'crop' => true,
