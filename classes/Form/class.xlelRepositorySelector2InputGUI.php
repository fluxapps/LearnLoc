...
require_once('class.xlelExplorerSelectInputGUI.php');
/**
 ...
 *
 */
class xlelRepositorySelector2InputGUI extends xlelExplorerSelectInputGUI {
	...
	function __construct($a_title, $a_postvar, $a_multi = false) {
		...
		$this->explorer_gui = new ilRepositorySelectorExplorerGUI(array(
			"ilpropertyformgui",
			"ilformpropertydispatchgui",
			"ilrepositoryselector2inputgui",
		), $this->getExplHandleCmd(), $this, "selectRepositoryItem", "root_id");
